...
const warrantyAPI = {
  ...
  getCustomerListWarrantyReceipt: (params: any) => {
    return axiosInstance.post('/warranty_receipt_customer_controller/get_list_warranty_receipt', {
      params,
    })
  },
  ...
  getStoreListWarrantyReceipt: (params: any) => {
    return axiosInstance.post('/warranty_receipt_store_controller/get_list_warranty_receipt', {
      params,
    })
  },
  ...
  getStoreListPickingOrder: (params: any) => {
    return axiosInstance.post('/warranty_receipt_store_controller/get_list_picking_order', {
      params,
    })
  },
  ...
  searchWarrantyReceipt: (params: SearchWarrantyReceiptReq) => {
    return axiosInstance.post('/warranty_receipt_customer_controller/search_warranty_receipt', {
      params,
    })
  },
  ...
  getWarrantyProductDetail: (
    ...
    return axiosInstance.post('/warranty_receipt_customer_controller/get_detail_warranty_receipt', {
      params,
    })
  },
  ...
  getStoreWarrantyReceiptDetail: (
    ...
    return axiosInstance.post('/warranty_receipt_store_controller/get_detail_warranty_receipt', {
      params,
    })
  },
  ...
  getListWarrantyProduct: (params?: WarrantyParams) => {
    return axiosInstance.post('/detail_data_controller/get_list_product', {
      params,
    })
  },
  ...
  getListProductLot: (params?: WarrantyParams) => {
    return axiosInstance.post('/detail_data_controller/get_list_product_lot', {
      params,
    })
  },

  getListStore: (params?: GetListStoreReq) => {
    return axiosInstance.post('/account_controller/get_store', {
      params,
    })
  },
  ...
  createCustomerWarrantyReceipt: (params?: CreateWarrantyReceiptReq) => {
    return axiosInstance.post('/warranty_receipt_customer_controller/create_warranty_receipt', {
      params,
    })
  },
  ...
  createStoreWarrantyReceipt: (params?: WarrantyParams) => {
    return axiosInstance.post('/warranty_receipt_store_controller/create_warranty_receipt', {
      params,
    })
  },
  ...
  getListCustomer: (params?: WarrantyParams) => {
    return axiosInstance.post('/register_account_warranty_controller/get_list_customer', { params })
  },

  //Tìm kiếm tài khoản khách hàng (dành cho đại lí)
  searchCustomer: (params: WarrantyParams) => {
    return axiosInstance.post('/register_account_warranty_controller/search_customer', { params })
  },

  //upload hình ảnh hóa đơn
  createWarrantyAttachment: (params: CreateAttachmentReq) => {
    return axiosInstance.post('/detail_data_controller/create_attachment_data', { params })
  },

  //đại lí tạo mới tài khoản khách hàng bảo hành
  createCustomerWarranty: (params: CreateCustomerWarrantyReq) => {
    return axiosInstance.post('/register_account_warranty_controller/create_customer', { params })
  },

  //Lấy thông tin chi tiết của khách hàng
  getCustomerInfoDetail: (params: WarrantyParams) => {
    return axiosInstance.post('/register_account_warranty_controller/get_detail_customer', {
      params,
    })
  },
  ...
  updateCustomerInfo: (params: UpdateCustomerWarrantyReq) => {
    return axiosInstance.post('/register_account_warranty_controller/update_customer', {
      params,
    })
  },
  ...
  storeSearchWarrantyReceipt: (params: WarrantyParams) => {
    return axiosInstance.post('/warranty_receipt_store_controller/search_warranty_receipt', {
      params,
    })
  },
  ...
  updateCustomerWarrantyReceipt: (params: WarrantyParams) => {
    return axiosInstance.post('/warranty_receipt_customer_controller/update_warranty_receipt', {
      params,
    })
  },
  ...
  updateStoreWarrantyReceipt: (params: WarrantyParams) => {
    return axiosInstance.post('/warranty_receipt_store_controller/update_warranty_receipt', {
      params,
    })
  },
  ...
  deleteCustomerWarrantyReceipt: (params: WarrantyParams) => {
    return axiosInstance.post('/warranty_receipt_customer_controller/delete_warranty_receipt', {
      params,
    })
  },
  ...
  deteleStoreWarrantyReceipt: (params: WarrantyParams) => {
    return axiosInstance.post('/warranty_receipt_store_controller/delete_warranty_receipt', {
      params,
    })
  },
}
